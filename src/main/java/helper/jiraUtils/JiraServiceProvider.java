...
public class JiraServiceProvider {
	...
	public void createJiraIssue(String issueType, String summary, String description, String assignee) {
		/* Create a new issue. */
		try {
			...
			//Add the assignee
			newIssueFluentCreate.field(Field.ASSIGNEE, assignee);
			//add attachment
		//	newIssueFluentCreate.field(Field.ATTACHMENT, destinationPath);
